...
public class TestParameters
{
	...
	private ExecutionParameters execParam = new ExecutionParameters();

	/**
	 * @return the execParam
	 */
	public ExecutionParameters getExecParam() {
		return execParam;
	}

	/**
	 * @param execParam
	 *            the execParam to set
	 */
	public void setExecParam(ExecutionParameters execParam) {
